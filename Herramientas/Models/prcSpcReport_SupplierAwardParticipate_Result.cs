...
namespace Herramientas.Models
{
    ...
    public partial class prcSpcReport_SupplierAwardParticipate_Result
    {
        ...
        public Nullable<int> Num_Licitacion_Adjudica { get; set; }
        public Nullable<int> Num_Licitacion_Participa { get; set; }
